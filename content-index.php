...
<div class="body p-0">
	...
	<div class="surroundings" id="surroundings">
		<img class="w-100" src="<?php bloginfo('template_directory');?> /images/surroundings.png"
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-lg-6">
					...
					<div class="text">
						Untuk memberikan keseimbangan hidup, New Lippo Cikarang juga menciptakan pusat yang menyenangkan
			...
			<div class="row">
				...
				<div class="col-12 col-lg-6">
					...
					<div class="text">
						Terintegrasi dengan banyak lingkungan hijau, Wellness Hub memberikan tempat terbaik untuk hidup
